...
public static void main(String[] args) {	
	...
	public Principal() {
		...
		BolinhaController bolinhaController = new BolinhaController(lblBolinha1, lblBolinha2, lblBolinha3, btnIniciar);
